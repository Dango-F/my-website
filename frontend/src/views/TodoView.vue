            ...
            <div>
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex flex-col items-end gap-2">
                        <button @click="refreshTodos" class="px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors flex items-center cursor-pointer" :disabled="todoStore.isLoading || todoBlocked">
