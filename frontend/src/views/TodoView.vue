        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6"
            ...
            <div>
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
                    <h1 class="text-xl sm:text-2xl font-bold">待办事项</h1>
                    <button @click="refreshTodos" class="touch-target w-full sm:w-auto px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors flex items-center justify-center cursor-pointer" :disabled="isRefreshing">
